...
import MovableSong from '../../components/MovableSong/MovableSong';

// www.youtube.com/watch?v=Ia2y0GDEuPc&ab_channel=eveningkid
  ...
  return (
    <SafeAreaView>
      <Animated.ScrollView
        ...
        {SONGS.map(song => (
          <MovableSong {...song} scrollY={scrollY} positions={positions} />
        ))}
      </Animated.ScrollView>
    </SafeAreaView>
  );
